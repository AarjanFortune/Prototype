...
# except jams_to_midi nothing is really useful so it can be removed. 
...
#this save_small_wav and sonify_jams can be removed as it is used to generate audio only from the annotations
